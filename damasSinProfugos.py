...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def moverFicha(self, posX, posY, newX, newY, comer):
        print("VENIA DE "+str(posX+1) + " " + str(posY+1) + " Y ME HE IDO A " + str(newX+1) + " " + str(newY+1))
        self.quitarColor()
        ...
        for button in negras:
            if posX>0 and posX<7 and posY>0 and posY<7:
                if button.objectName() == arrayTablero[posX-1][posY-1].objectName() or button.objectName() == arrayTablero[posX-1][posY+1].objectName():
                    print("ME BORRO NEGRO COMIDA")
                    del negras[cont]
                cont = cont + 1
        cont = 0
        for button in blancas:
            if button.objectName() == arrayTablero[posX][posY].objectName():
                print("ME BORRO BLANCA")
                del blancas[cont]
            cont = cont + 1
        cont = 0
    ...
    def moverFichaNegras(self, posX, posY, newX, newY, comer):
        self.quitarColor()
        arrayTablero[posX][posY].setText("")
        arrayTablero[posX][posY].setStyleSheet("background-color:yellow")
        ...
        for button in blancas:
            if posX > 0 and posX < 7 and posY > 0 and posY < 7:
                if button.objectName() == arrayTablero[posX+1][posY-1].objectName() or button.objectName() == arrayTablero[posX+1][posY+1].objectName():
                    print("ME BORRO BLANCA COMIDA")
                    del blancas[cont]
                cont = cont + 1
        cont = 0
        for button in negras:
            if button.objectName() == arrayTablero[posX][posY].objectName():
                print("ME BORRO NEGRO")
                del negras[cont]
            cont = cont + 1
        cont = 0
